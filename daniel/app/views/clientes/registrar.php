...
<head>
    ...
    <title>Registrar cliente - <?= TITLE_BUSINESS ?></title>
...
<main class="main-panel">
    <nav class="breadcrumb">
        ...
        <span id="breadcrumb-page">Registrar cliente</span>
    </nav>
    <div class="main-content">
        <div class="card shadow-sm">
            <div class="card-body">
                <form method="POST" action="<?= BASE_URL ?>/clientes/guardar" class="row g-3">
                    <div class="col-md-4"><label class="form-label">Nombre</label><input type="text" name="nombre" class="form-control" required></div>
                    <div class="col-md-4"><label class="form-label">Documento</label><input type="text" name="documento" class="form-control" required></div>
